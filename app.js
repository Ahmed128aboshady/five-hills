...
const translations = {
    en: {
        ...
        btnHeroPres: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="5 3 19 12 5 21 5 3"></polygon></svg> Launch 3D Portfolio Deck',
        ...
        founderBio1: "Ashraf El Shenawy is a seasoned Real Estate & Financial Advisor with over a decade of hands-on experience in Dubai's dynamic property market. Beyond brokerage, he is a proven portfolio manager overseeing 20+ premium properties, including residential towers, luxury villas, and a commercial retail mall, totaling 500+ managed units across Dubai. His expertise spans asset acquisition, tenant management, rental yield optimization, and full-cycle property operations, making him an unmatched partner for investors seeking both ownership and seamless long-term management.",
    ...
    ar: {
        ...
        btnHeroPres: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="5 3 19 12 5 21 5 3"></polygon></svg> ابدأ العرض الرقمي ثلاثي الأبعاد',
        lblLocation: "الموقع",
